...
namespace Drupal\votingapi_rating\Plugin\Field\FieldFormatter;
...
use Drupal\votingapi_rating\Plugin\VotingApiWidgetManager;
...
class VotingApiFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
   ...
   * @param \Drupal\votingapi_rating\Plugin\VotingApiWidgetManager $widget_manager
